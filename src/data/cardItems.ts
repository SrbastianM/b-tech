import { BlogCardProps } from "@/app/blog/components/BlogCard";
...
export const cardItems : BlogCardProps[] = [
  {
    ...
    tags: [
      {tagName: "web"}, {tagName: "backend"}, {tagName: "mobile"}
    ]
  },
  {
    image: testingImage.src,
    ...
    tags: [
      {tagName: "mobile"}, {tagName: "web"}, {tagName: "backend"}
    ]
  },
  {
    image: testingImage.src,
    ...
    tags: [
      {tagName: "backend"}, {tagName: "web"}, {tagName: "mobile"}
    ]
  },
]